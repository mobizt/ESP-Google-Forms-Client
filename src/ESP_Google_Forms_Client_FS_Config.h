#ifndef ESP_GOOGLE_FORMS_CLIENT_FS_CONFIG_H_
#define ESP_GOOGLE_FORMS_CLIENT_FS_CONFIG_H_
...
#if !defined(ESP_SIGNER_USE_PSRAM) && defined(ESP_GOOGLE_FORMS_CLIENT_USE_PSRAM)
#define ESP_SIGNER_USE_PSRAM ESP_GOOGLE_FORMS_CLIENT_USE_PSRAM
#endif

// To use external Client.
// #define ESP_GOOGLE_FORMS_CLIENT_ENABLE_EXTERNAL_CLIENT
...
// To use your custom config, create Custom_GForms_FS_Config.h in the same folder of this 
// ESP_Google_Forms_Client_FS_Config.h file
#if __has_include("Custom_GForms_FS_Config.h")
#include "Custom_GForms_FS_Config.h"
#endif
