...
#ifndef GFORMS_CONST_H
#define GFORMS_CONST_H

#define GFORMS_DEFAULT_AUTH_TOKEN_PRE_REFRESH_SECONDS 5 * 60

#define GFORMS_DEFAULT_AUTH_TOKEN_EXPIRED_SECONDS 3600

#define GFORMS_DEFAULT_REQUEST_TIMEOUT 2000

#define GFORMS_DEFAULT_TS 1618971013

#define GFORMS_TIME_SYNC_INTERVAL 5000

#define GFORMS_MIN_TOKEN_GENERATION_ERROR_INTERVAL 5 * 1000

#define GFORMS_MIN_NTP_SERVER_SYNC_TIME_OUT 15 * 1000

#define GFORMS_MIN_TOKEN_GENERATION_BEGIN_STEP_INTERVAL 300

#define GFORMS_MIN_SERVER_RESPONSE_TIMEOUT 1 * 1000
#define GFORMS_DEFAULT_SERVER_RESPONSE_TIMEOUT 5 * 1000
#define GFORMS_MAX_SERVER_RESPONSE_TIMEOUT 60 * 1000

#define GFORMS_MIN_WIFI_RECONNECT_TIMEOUT 10 * 1000
#define GFORMS_MAX_WIFI_RECONNECT_TIMEOUT 5 * 60 * 1000
...
#include "ESP_Google_Forms_Client_FS_Config.h"
...
typedef enum
{
    esp_google_forms_file_storage_type_undefined,
    esp_google_forms_file_storage_type_flash,
    esp_google_forms_file_storage_type_sd
} esp_google_forms_file_storage_type;

typedef enum
{
    gforms_tcp_client_type_undefined,
    gforms_tcp_client_type_internal,
    gforms_tcp_client_type_external

} gforms_tcp_client_type;

typedef enum
{
    gforms_cert_type_undefined = -1,
    gforms_cert_type_none = 0,
    gforms_cert_type_data,
    gforms_cert_type_file
...
struct gforms_no_eth_module_t
{
};

#ifndef ESP8266_SPI_ETH_MODULE
#define ESP8266_SPI_ETH_MODULE gforms_no_eth_module_t
#endif

struct gforms_wifi_credential_t
{
    MB_String ssid;
    MB_String password;
};

class esp_gforms_wifi
{
public:
    esp_gforms_wifi() { clearAP(); };
    ~esp_gforms_wifi() { credentials.clear(); };
    void addAP(const String &ssid, const String &password)
    {
        gforms_wifi_credential_t data;
        data.ssid = ssid;
    ...
    gforms_wifi_credential_t operator[](size_t index)
    {
        return credentials[index];
    }

    private:
    MB_List<gforms_wifi_credential_t> credentials;
};

struct gforms_url_info_t
{
    MB_String host;
    MB_String uri;
    MB_String auth;
...
struct gauth_token_signer_resources_t
{
    ...
    unsigned long preRefreshSeconds = GFORMS_DEFAULT_AUTH_TOKEN_PRE_REFRESH_SECONDS;
    unsigned long expiredSeconds = GFORMS_DEFAULT_AUTH_TOKEN_EXPIRED_SECONDS;
    /* request time out period (interval) */
    unsigned long reqTO = GFORMS_DEFAULT_REQUEST_TIMEOUT;
...
struct gforms_chunk_state_info
{
    int state = 0;
    int chunkedSize = 0;
    int dataLen = 0;
...
struct gforms_tcp_response_handler_t
{
    ...
    gforms_chunk_state_info chunkState;
...
struct gforms_server_response_data_t
{
    int httpCode = 0;
...
typedef void (*GFORMS_NetworkConnectionRequestCallback)(void);
typedef void (*GFORMS_NetworkStatusRequestCallback)(void);
typedef void (*GFORMS_ResponseCallback)(const char *);

static const unsigned char gforms_base64_table[65] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";
...
static const char gauth_pgm_str_34[] PROGMEM = "https://www.googleapis.com/auth/drive https://www.googleapis.com/auth/forms.body https://www.googleapis.com/auth/forms.responses.readonly";
...
static const char gforms_pgm_str_1[] PROGMEM = "\r\n";
static const char gforms_pgm_str_2[] PROGMEM = ".";
static const char gforms_pgm_str_3[] PROGMEM = "googleapis.com";
static const char gforms_pgm_str_4[] PROGMEM = "Host: ";
static const char gforms_pgm_str_5[] PROGMEM = "Content-Type: ";
static const char gforms_pgm_str_6[] PROGMEM = "Content-Length: ";
static const char gforms_pgm_str_7[] PROGMEM = "User-Agent: ESP\r\n";
static const char gforms_pgm_str_8[] PROGMEM = "Connection: keep-alive\r\n";
static const char gforms_pgm_str_9[] PROGMEM = "Connection: close\r\n";
static const char gforms_pgm_str_10[] PROGMEM = "GET";
static const char gforms_pgm_str_11[] PROGMEM = "POST";
static const char gforms_pgm_str_12[] PROGMEM = "PATCH";
static const char gforms_pgm_str_13[] PROGMEM = "DELETE";
static const char gforms_pgm_str_14[] PROGMEM = "PUT";
static const char gforms_pgm_str_15[] PROGMEM = " ";
static const char gforms_pgm_str_16[] PROGMEM = " HTTP/1.1\r\n";
static const char gforms_pgm_str_17[] PROGMEM = "Authorization: ";
static const char gforms_pgm_str_18[] PROGMEM = "Bearer ";
static const char gforms_pgm_str_19[] PROGMEM = "true";
static const char gforms_pgm_str_20[] PROGMEM = "Connection: ";
static const char gforms_pgm_str_21[] PROGMEM = "Content-Type: ";
static const char gforms_pgm_str_22[] PROGMEM = "Content-Length: ";
static const char gforms_pgm_str_23[] PROGMEM = "ETag: ";
static const char gforms_pgm_str_24[] PROGMEM = "Transfer-Encoding: ";
static const char gforms_pgm_str_25[] PROGMEM = "chunked";
static const char gforms_pgm_str_26[] PROGMEM = "Location: ";
static const char gforms_pgm_str_27[] PROGMEM = "HTTP/1.1 ";
static const char gforms_pgm_str_28[] PROGMEM = "?";
static const char gforms_pgm_str_29[] PROGMEM = "&";
static const char gforms_pgm_str_30[] PROGMEM = "=";
static const char gforms_pgm_str_31[] PROGMEM = "/";
static const char gforms_pgm_str_32[] PROGMEM = "https://";
static const char gforms_pgm_str_33[] PROGMEM = "https://%[^/]/%s";
static const char gforms_pgm_str_34[] PROGMEM = "http://%[^/]/%s";
static const char gforms_pgm_str_35[] PROGMEM = "%[^/]/%s";
static const char gforms_pgm_str_36[] PROGMEM = "%[^?]?%s";
static const char gforms_pgm_str_37[] PROGMEM = "auth=";
static const char gforms_pgm_str_38[] PROGMEM = "%[^&]";
static const char gforms_pgm_str_39[] PROGMEM = "undefined";
static const char gforms_pgm_str_40[] PROGMEM = "OAuth2.0 access token";
static const char gforms_pgm_str_41[] PROGMEM = "uninitialized";
static const char gforms_pgm_str_42[] PROGMEM = "on initializing";
static const char gforms_pgm_str_43[] PROGMEM = "on signing";
static const char gforms_pgm_str_44[] PROGMEM = "on exchange request";
static const char gforms_pgm_str_45[] PROGMEM = "on refreshing";
static const char gforms_pgm_str_46[] PROGMEM = "error";
static const char gforms_pgm_str_47[] PROGMEM = "code: ";
static const char gforms_pgm_str_48[] PROGMEM = ", message: ";
static const char gforms_pgm_str_49[] PROGMEM = "ready";
