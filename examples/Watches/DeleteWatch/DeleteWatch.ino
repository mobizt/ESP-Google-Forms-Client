...
// This example shows how to delete a form's watch.
...
void loop()
{
    ...
    if (ready && !taskComplete)
    {
        ...
        Serial.println("\nDelete a form's watch...");
        Serial.println("------------------------------");

        FirebaseJson response;

        // For Google Forms API ref doc, go to https://developers.google.com/forms/api/reference/rest/v1/forms.watches/delete

        bool success = GForms.deleteWatch(&response, "<formId>>" /* form ID to request */, "<watchId>" /* watch ID */);
        if (success)
