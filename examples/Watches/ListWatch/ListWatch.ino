...
// This example shows how to list a form's watches.
...
void loop()
{
    ...
    if (ready && !taskComplete)
    {
        ...
        // For Google Forms API ref doc, go to https://developers.google.com/forms/api/reference/rest/v1/forms.watches/list

        bool success = GForms.listWatches(&response, "<formId>>" /* form ID to request */);
        if (success)
