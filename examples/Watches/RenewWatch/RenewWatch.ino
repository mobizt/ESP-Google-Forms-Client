...
// This example shows how to renew a form's watches.
...
void loop()
{
    ...
    if (ready && !taskComplete)
    {
        ...
        Serial.println("\nRenew a form's watch...");
        Serial.println("------------------------------");

        FirebaseJson response;

        // For Google Forms API ref doc, go to https://developers.google.com/forms/api/reference/rest/v1/forms.watches/renew

        bool success = GForms.renewWatch(&response, "<formId>" /* form ID to request */, "<watchId>"/* watch ID */);
        if (success)
