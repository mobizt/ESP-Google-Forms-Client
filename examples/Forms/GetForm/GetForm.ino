...
// This example shows how to get a form.
...
void loop()
{
    ...
    if (ready && !taskComplete)
    {
        ...
        // For Google Forms API ref doc, go to https://developers.google.com/forms/api/reference/rest/v1/forms/get

        bool success = GForms.getForm(&response /* returned response */, "<formId>" /* form ID to request */);
        if (success)
